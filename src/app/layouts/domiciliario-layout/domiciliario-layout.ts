      ...
      <header class="flex items-center justify-between px-5 py-3 border-b border-white/10 shrink-0">
        <div class="flex items-center gap-2.5">
          ...
          <div>
            ...
            <p class="text-indigo-400 text-[10px] font-semibold">Domiciliario</p>
          </div>
        </div>

        <div class="flex items-center gap-2">
          <div class="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-white/5 border border-white/10">
            <div class="w-5 h-5 rounded-full bg-indigo-500/30 flex items-center justify-center shrink-0">
...
export class DomiciliarioLayout {
